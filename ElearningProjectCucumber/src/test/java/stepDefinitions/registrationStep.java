...
public class registrationStep {
	...
	public void tearDown(Scenario scenario) throws IOException {
		...
		if (scenario.isFailed()) {
			...
			File filePerm = new File(
					"C:\\Users\\HariniKantheti\\Desktop\\SDET training\\Workspace\\SeleniumCucumberProj\\FailedScreenshot\\"
	...
	public void the_registration_confirmation_page_and_we_validate_the_and(String firstName, String lastName)
		...
		Assert.assertEquals(firstName.contains("Harini"), actualText.contains("Harini"));
		Assert.assertEquals(lastName.contains("Kantheti"), actualText.contains("Kantheti"));
		Thread.sleep(5000L);
